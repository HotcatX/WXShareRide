...
export const isNoticeVersion = value => typeof value === 'string' && /^ride-research-notice-20\d\d-\d\d-\d\d(?:-[1-9]\d{0,3})?$/.test(value);
export function loadBridgeKey(path) {
  ...
  } catch { throw new Error('Invalid research bridge key file'); }
