const POSTER_FILE_ID =
  "cloud://cloud1-7gmtcu4s3aebce27.636c-cloud1-7gmtcu4s3aebce27-1383643768/coupons/restaurant/小串店/xiaochuandian.png.jpeg"

const COUPON_FILE_ID =
  "cloud://cloud1-7gmtcu4s3aebce27.636c-cloud1-7gmtcu4s3aebce27-1383643768/coupons/restaurant/小串店/小串店.jpg"

// ✅ 统计写入：Log 集合里这条记录
const LOG_DOC_ID = "XiaoChuanDian"
...
Page({
  data: {
    ...
    restaurant: {
      headerTop: "",
      name: "Xiao Chuan Dian",
      titleCN: "小串店",
      subtitle: "工作日，给自己一顿热乎的家常味道",
      detailTitle: "详细信息",
      detailLine1: "周一到周四 电话预约 现金/RMB支付9折 刷卡支付9.5折",
      detailLine2: "到店出示优惠券图片即可使用",
      address: "8 Henry Ave, PalisadesPark"
    },
  ...
  logAction(action) {
    ...
    wx.cloud
      .callFunction({
        name: "logCounter",
        data: {
          _id: LOG_DOC_ID, // ✅ 写入 Log/_id = "XiaoChuanDian"
