...
更新：2026-09-23。当前上线读回见[首期记录](research-rollout-2026-09-23.md)，仍由部署负责人补齐，不以代码存在推断真实用户已在上传。
...
准备期曾通过服务器12项与客户端20项合成测试，含丢ACK原样重试、重启、撤回、满盘不ACK等。本期服务端代理报告22项通过，新增HMAC、CAS、恢复空库阻断和保留验证；运维停止工具本地8项通过。新前端/统一云入口及真实部署测试以[上线记录](research-rollout-2026-09-23.md)读回为准，旧测试不能证明当前发布完成。
