...
import { APPID, ENDPOINT, deriveSubject, parseInput, readPrivateFile, readStdin,
...
const state = (status, statusVersion) => ({ ok: true, status, statusVersion, purposeVersion: DEFAULT_PURPOSE_VERSION,
  noticeVersion: DEFAULT_NOTICE_VERSION, ...(status === 'none' ? {} : { participantKey: 'synthetic_participant_key' }) });
